...
|---|---|---|---|---|
| TD-1 | **Bypass superadmin dev** per ivan.lotorto@gmail.com: vede/usa le funzioni admin di ogni lega lato frontend | `artifacts/mister-web/src/lib/dev-superadmin.ts` + 2 import (`grep dev-superadmin`) | 2026-09-04, per sbloccare i test config lega | Cancellare il file e gli import quando: (a) admin corretto sulle leghe seed, (b) gating server-side "Passo B" auth |
